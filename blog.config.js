...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '多🧊，少🍬，不要🌶️。, 欲买桂花同载酒，终不似少年游。, 云想衣裳花想容，春风拂槛露华浓。,123456',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'marvin-season', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '芜湖～🤪', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://marvin-season.vercel.app', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/marvin-season', // 你的github个人主页 例如 https://github.com/tangly1024
...
//     },
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/concepts/analytics/quickstart https://github.com/marvin-season/NotionNext/issues/897
